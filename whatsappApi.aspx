<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="whatsappApi.aspx.cs" Inherits="WebApplication7.whatsappApi" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>WhatsApp API Solutions <%= ecity.ToString() %>| WhatsApp Business & Message API</title>
    <meta name="description" content="Explore WhatsApp API solutions <%= ecity.ToString() %> for effective business communication. Utilize WhatsApp API to send messages seamlessly." />
    <meta name="keywords" content="WhatsApp API <%= ecity.ToString() %>, WhatsApp Business API <%= ecity.ToString() %>, WhatsApp Message API <%= ecity.ToString() %>, WhatsApp API to send message <%= ecity.ToString() %>" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <section>
            <div class="container ">
                <div class="row align-items-center align-content-center">
                    <div class="col-lg-6 col-md-12 wow bounceInLeft animated animated" style="visibility: visible; animation-name: bounceInLeft;">
                        <div class="seo-2-why-choose-text">
                            <div class="seo-2-section-title seo-2-headline">
                                <h1 class="heading_h1">Boost Your Sales With
                             <span style="color: green; font-weight: bold;">WhatsApp API</span> Services <%=ecity.ToString()%>
                                </h1>
                                <br />
                                <h4 class="heading_h4">End-To-End commerce journey, leveraging the power of WhatsApp API Integration and Online Marketing Strategies.</h4>
                                <p class="content">Explore enhanced communication with Softcron Technologies' WhatsApp API Integration. Seamlessly integrate the power of WhatsApp into your business strategy, ensuring efficient and effective engagement with your audience. Elevate your online presence through our specialized service.</p>
                                <br />
                                <a class="comment-reply ms--4" href="https://api.whatsapp.com/send?phone=919044892448&amp;forceIntent=true&amp;load=loadInIOSExternalSafari&amp;text=WhatsApp API" target="_blank"><span>Get Demo</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 order-md-last order-first">
                        <div class="seo-2-why-choose-img wow zoomIn" data-wow-delay="500ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 500ms; animation-name: zoomIn;">
                            <!-- Your image here -->
                            <style data-emotion-css="167b0u4">
                                .css-167b0u4 {
                                    display: inline-block;
                                    vertical-align: middle;
                                    max-width: 100%; /* Allow the image to resize automatically */
                                ...
                                @media (max-width:530px) {
                                    .site-header .composite .widget .css-167b0u4 {
                                        max-width: calc(100% - 80px);
                                    }
                                }
                            </style>
                            <%-- image 1 --%>
                            <img class="lp-image-react w-fd088d92-c248-50b8-fc8c-39c82b6dbcaa css-167b0u4 lazyload" src="/assets/img/whatsappApi/WhatsAppAPIIntegration.webp" height="380" width="570" alt="WhatsApp-API-Integration">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <%-- impact part start here  --%>
        <section>
            <div class="container mt-5 ">
                <h2 class="text-center mb-4 heading_h1">Drive Measurable Business Impact with Softcron <%= ecity.ToString() %></h2>
                <div class="row">
                    <div class="col-md-3">
                        <div class="card text-center text-white" style="background-color: #128C7E">
                            <div class="card-body">
                                <h3 class="card-title">500+</h3>
                                <p class="card-text">Live WhatsApp solutions</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card text-center  text-white" style="background-color: #F4A261">
                            <div class="card-body">
                                <h3 class="card-title">2.4X</h3>
                                <p class="card-text">Increase in cart additions</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card text-center text-white" style="background-color: #3A9D9F">
                            <div class="card-body">
                                <h3 class="card-title">60%</h3>
                                <p class="card-text">Increase in cart recovery</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card text-center  text-white" style="background-color: #E9C46A">
                            <div class="card-body">
                                <h3 class="card-title">68%</h3>
                                <p class="card-text">Repeat purchases</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <%-- impact part end here --%>


        <%-- container2 begin --%>
        <section>
            <div class="dia-fun-fact-section mt-5">
                <div class="container">
                    <div class="container">
                            ...
                            <div class="col-lg-6 order-lg-first">
                                <div class="p-4 text-center">
                                    <div class="card border-0 shadow">
                                        <%-- image 2 --%>
                                        <img src="/assets/img/whatsappApi/DigitalMarketingAgency_NextPage.webp" alt="Digital-MarketingAgency_NextPage Messaging on Phone and Message" class="img-fluid rounded">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 order-lg-last">
                                <div class="p-4">
                                    <h2 class="text-left heading_h1" style="font-size: 2rem">Built to Scale with WhatsApp Business API Integration <%= ecity.ToString() %></h2>
                                    <p class="content">At our Digital Marketing Agency, we specialize in creating Effective Communication Solutions that help you reach your customers everywhere.  With our expertise in WhatsApp API Integration, we empower your business to connect and engage with your audience through the versatile WhatsApp Business Platform.</p>
                                    <p class="content">Our Whatsapp API Providers services go beyond traditional approaches.</p>
                                    <ul>
                                        <li class="content">Product Discovery: Bring your product catalog to WhatsApp and enable product discovery and purchase</li>
                                        <li class="content">Product Recommendations: Offer tailored product recommendations that boost purchases and improve average order value to whatsapp cloud api pricing</li>
                                    </ul>
                                    <br />
                                    <a class="comment-reply" href="/contact-us"><span>Learn more</span></a>
                                </div>
                            </div>
                        </div>
        ...
        <%-- container 4 start here  commented for now --%>
        <section>
                ...
                <div class="row align-items-center align-content-center">
                    <div class="col-lg-6 col-md-12 wow bounceInLeft animated animated" style="visibility: visible; animation-name: bounceInLeft;">
                        <div class="seo-2-why-choose-text">
                            <div class="seo-2-section-title seo-2-headline">
                                <h2
                                    class="lp-headline text-align-left font-scale-8 line-height-scale-3 gutter-bottom-1 subhead heading_h1">
                                    <span>Sell More with your WhatsApp Store</span>
                                </h2>
                                <br />
                                <p class="content">Discover the potential of your business with Softcron Technologies <%=ecity.ToString() %>, a versatile Digital Marketing Agency. Our expertise spans a variety of services including Web Design, SEO, and Professional Web Development. We're dedicated to delivering Effective Communication Solutions that enrich your business's online presence.</p>
                                <ul class="lp-list text-align-left font-scale-5 line-height-scale-4 gutter-bottom-1 lp-list--bullet content"
                                    data-guid="85dde75f-08cc-bbc9-66ab-f4acdc12c899">
                                    <li><span style="color: rgba(95, 104, 128, 1);"><span
                                        style="font-style: normal"><span
                                            style="font-weight: 400">Showcase relevant products
                                                           from your catalog with WhatsApp product messages
                                                           through commerce API</span></span></span></li>
                                    <li><span style="color: rgba(95, 104, 128, 1);"><span
                                        style="font-style: normal"><span
                                            style="font-weight: 400">Send interactive multi and
                                                           single-product messages to present products from
                                                           your inventory</span></span></span></li>
                                    <li><span style="color: rgba(95, 104, 128, 1);"><span
                                        style="font-style: normal"><span
                                            style="font-weight: 400">Allow adding products to
                                                           the shopping cart without risking obsolete
                                                           information such as price and
                                                           availability</span></span></span></li>
                                </ul>

                                <br />
                                <%--<button style="background-color: #25D366; color: #ffffff; border: 1px solid #25D366; border-radius: 4px; padding: 10px 20px; font-size: 16px; cursor: pointer;"><a href="https://api.whatsapp.com/send?phone=919044892448&amp;forceIntent=true&amp;load=loadInIOSExternalSafari&amp;text=Quotation?">Get a Demo</a></button>--%>
                    ...
                    <div class="col-lg-6 col-md-12 order-md-last order-first">
                        <div class="seo-2-why-choose-img wow zoomIn" data-wow-delay="500ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 500ms; animation-name: zoomIn;">
                            ...
                            <%-- image3 --%>
                            <img class="lp-image-react w-fd088d92-c248-50b8-fc8c-39c82b6dbcaa css-167b0u4 lazyload" src="/assets/img/whatsappApi/SEOServices.webp" height="380" width="570" alt="SEO-Services">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <%-- our feature section begin --%>
        <section>
            <div class="container mt-3 mb-5">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-center mb-4 heading_h1" style="font-size: 37px">Our Features</h2>
                    </div>
                    <div class="col-lg-4">
                        <div class="card border-0 shadow mb-4">
                            <div class="card-body">
                                <h5 class="card-title" style="color: #09d32f">Automated Replies</h5>
                                <p class="card-text">Set up automated replies to greet customers, answer FAQs, and provide support round the clock.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 shadow mb-4">
                            <div class="card-body">
                                <h5 class="card-title" style="color: #ff7b01">Broadcast Messages</h5>
                                <p class="card-text">Send broadcast messages to engage with your customers in a timely and personalized manner.</p>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 shadow mb-4">
                            <div class="card-body">
                                <h5 class="card-title text-nowrap" style="color: #390ed2">Analytics and Reporting</h5>
                                <p class="card-text">Track the performance of your WhatsApp campaigns with detailed analytics and reporting.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section>
            <div class="container">
                <br />
                <h2 class="tableh2 text-center mb-4 heading_h1">WhatsApp Business Comparison</h2>
                <table class="table  table-hover table-rounded" style="border-radius: 30px">
                    ...
                    <tbody>
                        <tr>
                            <td>Broadcasting Limit</td>
                            <td><span class="checkmark">✓</span> UNLIMITED Users/ Day</td>
                            <td><span class="crossmark">✗</span> 256 Contacts</td>
                        </tr>
                        <tr>
                            <td>Multi-User Access</td>
                            <td><span class="checkmark">✓</span> Unlimited Users</td>
                            <td><span class="crossmark">✗</span> Up to 5 Devices</td>
                        </tr>
                        <tr>
                            <td>Install Chatbots</td>
                            <td><span class="checkmark">✓</span> Yes</td>
                            <td><span class="crossmark">✗</span> Not Possible</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Broadcast Reaches</td>
                            <td><span class="checkmark">✓</span> All Users</td>
                            <td><span class="crossmark">✗</span> Only who have saved your number</td>
                        </tr>
                        <tr>
                            <td>Coding Required</td>
                            <td><span class="crossmark">✗</span> Yes, But Not Required </td>
                            <td><span class="checkmark">✓</span> No, As App given by Whatsapp</td>
                        </tr>
                        <tr>
                            <td>Verified Green Tick</td>
                            <td><span class="checkmark">✓</span> Yes</td>
                            <td><span class="crossmark">✗</span> Not Possible</td>
                        </tr>
                        <tr>
                            <td>Clickable Messages</td>
                            <td><span class="checkmark">✓</span> Yes</td>
                            <td><span class="crossmark">✗</span> No</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <%-- container 3 start her  --%>
        <section>
            <div class="container mt-5 mb-5 ">
                <div class="row align-items-center align-content-center ">
                    <div class="col-lg-6 order-md-first order-last wow bounceInUp  animated py-5 py-lg-0 animated" style="visibility: visible; animation-name: bounceInUp;">
                        <%-- <div class="seo-2-why-choose-img">
                    <img src="/assets/img/bulk_whatsapp/phone2.webp" height="400" width="570" alt="Bulk_whatsapp" class="mx-auto d-block">
                </div>--%>
                        <div class="features-06__img_box">
                            <%-- image 4 --%>
                            <img class="lp-image-react w-fd088d92-c248-50b8-fc8c-39c82b6dbcaa   lazyload" src="/assets/img/whatsappApi/EffectiveCommunicationSolutions.webp" height="380" width="570" style="margin-right: 50px" alt="Effective-Communication-Solutions">
                        </div>
                    </div>
                    <div class="col-lg-6 wow bounceInRight  animated animated" style="visibility: visible; animation-name: bounceInRight;">
                        <div class="seo-2-why-choose-text">
                            <div class="seo-2-section-title seo-2-headline pera-content content">

                                <div class="title-box">
                                    <h2 class="heading features-06__heading heading_h1">3X Sales with CTA Notifications</h2>
                                    <div class="title-box__text features-06__text content_box">
                                        <p style="font-size: 17px">
                                            Drive <strong>45-60% Click Rates</strong> with Whatsapp CTA Notifications. Harness the power of Whatsapp API Integration to enrich 
                                            your customer engagement strategy. Discover the potential of Whatsapp CTA Notifications, boasting an impressive 45-60% Click Rate and delivering instant conversions with impact!
                                            By utilizing clickable links and quick reply buttons, Whatsapp CTA Notifications offer an interactive experience, transforming your messages into dynamic invitations for engagement, exploration, and decisive action.
                                            Embrace the evolution from static text to vibrant messages. With Whatsapp CTA Notifications, your messages come alive, compelling recipients to connect, explore, and respond.
                                        </p>

                                        <br />
                                        <%--<button style="background-color: #25D366; color: #ffffff; border: 1px solid #25D366; border-radius: 4px; padding: 10px 20px; font-size: 16px; cursor: pointer;"><a href="https://api.whatsapp.com/send?phone=919044892448&amp;forceIntent=true&amp;load=loadInIOSExternalSafari&amp;text=Quotation?">Learn more</a></button>--%>
                                        <a class="comment-reply" href="/contact-us"><span>Learn more</span></a>
        ...
        <%-- technical section begin --%>
        <section>
            <div class="container mt-4">
                <div class="mt-4">
                    <div class="section-title text-center mb-4">
                        <i class="uil uil-chart-pie-alt text-primary h3"></i>
                        <h2 class="title mt-3 mb-3">Start working with Softcron and send messages via WhatsApp API</h2>
                        <p class="text-muted" style="text-transform: capitalize;">
                            Effortlessly create a chatbot and seamlessly integrate WhatsApp with your systems, whether it's ERP, CRM, 
                         your app, or website. You have the flexibility to use any programmable language to connect seamlessly with Softcron.
                        </p>

                    </div>

                    <div class="col mt-4 pt-2" id="nav-tabs">
                        <iframe loading="lazy" class="w-100" frameborder="0" scrolling="no" width="100%" height="600px" src="https://docs.ultramsg.com/embed.php?pid=1" title="API Documentation"></iframe>
                    </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-1 col-md-1 col-3 text-center py4 text-primary">
                                <a href="https://www.softcron.com/bulk-whatsapp-services" class="text-primary" target="_blank">
                            ...
                            <div class="col-lg-1 col-md-1 col-3 text-center py4 text-primary">
                                <a href="https://www.softcron.com/bulk-whatsapp-services" class="text-primary" target="_blank">
                                    ...
                                    <p style="color: grey">.Net</p>
                                </a>
                            </div>
                            <div class="col-lg-1 col-md-1 col-3 text-center py4 text-primary">
                                <a href="https://docs.ultramsg.com/?docs_tab=java-okhttp" class="text-primary" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="43" height="43" viewBox="0 0 45 45">
