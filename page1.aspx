<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="page1.aspx.cs" Inherits="WebApplication7.page1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="web-app-banner" class="web-app-banner-section position-relative">
        ...
        <div class="container mt-50 py-4">
                ...
                <div class="row align-items-center align-content-center">
                    <div class="col-lg-6 order-md-first order-last py-2">
                        <div class="text-center wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <img src="assets/img/bulk_sms/sms.png" alt="SMS">
                        </div>

                    </div>
                    <div class="col-lg-6 py-2">
                        <div class="web-app-banner-text web-app-headline ">
                            <h1 class="cd-headline push">Best Bulk SMS Services Panel Provider Company
                            ...
                            <p>
                                Softcron, Best Bulk SMS Service panel provider company , offers API, Bulk Messages to send OTP SMS, Transactional SMS, Promotional SMS to promote your business.
                            </p>
                            <a class="comment-reply" href="contact-us"><span>Get Demo</span></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="sa-team-inner" class="sa-team-inner-section inner-page-padding mt-50">
        <div class="container">
                        ...
                        <div class="sa-team-inner-inner-box">
                            <div class="str-team-img-text position-relative">
                                <div class="str-team-img">
                                    <img src="assets/img/web_development/web1.png" alt="">
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas eligendi exercitationem temporibus dignissimos expedita at consequatur. Aliquam earum illo harum.</p>
                    <ul>
